...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayout = QtWidgets.QFormLayout(self.levelstab)
        ...
        self.formLayout.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.levelmin)
        ...
        self.formLayout.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.levelmax)
        ...
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.setlevels)
        self.levelnum = QtWidgets.QLineEdit(self.levelstab)
        self.levelnum.setObjectName("levelnum")
        self.formLayout.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.levelnum)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.setstep)
        self.levelstep = QtWidgets.QLineEdit(self.levelstab)
        self.levelstep.setObjectName("levelstep")
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.levelstep)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.linlevel)
        ...
        self.formLayout.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.cdflevel)
        self.tabWidget.addTab(self.levelstab, "")
        self.styletab = QtWidgets.QWidget()
        self.styletab.setObjectName("styletab")
        self.formLayout_2 = QtWidgets.QFormLayout(self.styletab)
        ...
        self.formLayout_2.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.mapstyle)
        ...
        self.formLayout_2.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.opacity)
        self.fillstyle = QtWidgets.QCheckBox(self.styletab)
        self.fillstyle.setObjectName("fillstyle")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.fillstyle)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.LabelRole, self.contcheckmap)
        ...
        self.formLayout_2.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.contchecknone)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.LabelRole, self.contcheckcolor)
        ...
        self.formLayout_2.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.contcolor)
        self.contlabel = QtWidgets.QCheckBox(self.styletab)
        self.contlabel.setObjectName("contlabel")
        self.formLayout_2.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.contlabel)
        self.tabWidget.addTab(self.styletab, "")
        self.processtab = QtWidgets.QWidget()
        self.processtab.setObjectName("processtab")
        self.formLayout_3 = QtWidgets.QFormLayout(self.processtab)
        ...
        self.formLayout_3.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.resample)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.filtersize)
        self.smoothlabel = QtWidgets.QLabel(self.processtab)
        self.smoothlabel.setObjectName("smoothlabel")
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.LabelRole, self.smoothlabel)
        ...
        self.formLayout_3.setWidget(2, QtWidgets.QFormLayout.FieldRole, self.filtersigma)
        ...
        self.formLayout_3.setWidget(3, QtWidgets.QFormLayout.FieldRole, self.clipmin)
        ...
        self.formLayout_3.setWidget(4, QtWidgets.QFormLayout.FieldRole, self.clipmax)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.actionImport.setText(_translate("MainWindow", "&Read tab"))
        self.actionImport.setToolTip(_translate("MainWindow", "Read werami tab file"))
